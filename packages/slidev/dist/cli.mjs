...
import { a as parser, c as resolveAddons, d as updateFrontmatterPatch, i as resolveOptions, l as version, o as getThemeMeta, s as resolveTheme, u as loadSetups } from "./shared-BkrYm8A4.mjs";
import { t as createServer } from "./serve-DQLOIuD0.mjs";
...
cli.command("build [entry..]", "Build hostable SPA", (args) => exportOptions(commonOptions(args)).option("out", {
	...
	const { build } = await import("./build-1B0rYJwR.mjs");
